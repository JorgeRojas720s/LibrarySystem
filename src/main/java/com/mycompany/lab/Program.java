...
public class Program {
    ...
    Book bookInfo() {
        ...
        Person author = new BookAuthor("", authorID, "Author");
        authors.add(author);

        Book book = new Book(title, ISBM, authors);
    ...
    void selectOption(int opt) {
        switch (opt) {
            ...
            case 2: {
                Book book = bookInfo();
                book.create(book.getTitle(), book.getISBM(), book.getAuthors());
            }
            break;
            case 3: {
            ...
            case 4: {
                ...
                newBookInfo.create(newBookInfo.getTitle(), newBookInfo.getISBM(), newBookInfo.getAuthors());
            }
            break;
            case 5: {
                int ISBM = bookISBM();
                Book book = new Book("", ISBM, null);
                book.delete(ISBM);
            }
            break;
            case 6: {
